...
- [x] **NFR-01** - All design tokens implemented in src/styles/variables.css per DESIGN-SYSTEM.md
- [x] **NFR-02** - CSS reset + base styles in global.css (box-sizing, margin/padding, body, headings, .container, .section, .visually-hidden)
- [x] **NFR-03** - Component CSS in src/styles/components/*.css using BEM naming
- [x] **NFR-04** - Responsive typography overrides at <767px

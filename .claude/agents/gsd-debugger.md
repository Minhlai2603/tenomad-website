...
<required_reading>
@D:/gsd-tenomad-blog/.claude/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@D:/gsd-tenomad-blog/.claude/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/gsd-tenomad-blog/.claude
                  → checks D:/gsd-tenomad-blog/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/gsd-tenomad-blog/.claude/gsd-core
                  → writes to D:/gsd-tenomad-blog/.claude/gsd-core/hooks/
...
@D:/gsd-tenomad-blog/.claude/gsd-core/references/thinking-models-debug.md
...
- Read @D:/gsd-tenomad-blog/.claude/gsd-core/references/common-bug-patterns.md

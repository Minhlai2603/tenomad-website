...
Reference full template: `D:/gsd-tenomad-blog/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/gsd-tenomad-blog/.claude/gsd-core/templates/state.md`.

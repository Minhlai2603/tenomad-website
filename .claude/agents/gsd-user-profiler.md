...
<reference>
@D:/gsd-tenomad-blog/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `D:/gsd-tenomad-blog/.claude/gsd-core/references/user-profiling.md` to load:

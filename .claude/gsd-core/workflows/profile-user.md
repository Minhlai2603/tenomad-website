...
Key references:
- @D:/gsd-tenomad-blog/.claude/gsd-core/references/ui-brand.md (display patterns)
- @D:/gsd-tenomad-blog/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @D:/gsd-tenomad-blog/.claude/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="D:/gsd-tenomad-blog/.claude/gsd-core/USER-PROFILE.md"
...
```bash
cp "D:/gsd-tenomad-blog/.claude/gsd-core/USER-PROFILE.md" "D:/gsd-tenomad-blog/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at D:/gsd-tenomad-blog/.claude/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `D:/gsd-tenomad-blog/.claude/gsd-core/references/user-profiling.md`
...
Reference: @D:/gsd-tenomad-blog/.claude/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to D:/gsd-tenomad-blog/.claude/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to D:/gsd-tenomad-blog/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at D:/gsd-tenomad-blog/.claude/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at D:/gsd-tenomad-blog/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to D:/gsd-tenomad-blog/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="D:/gsd-tenomad-blog/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    D:/gsd-tenomad-blog/.claude/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   D:/gsd-tenomad-blog/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        D:/gsd-tenomad-blog/.claude/CLAUDE.md
```

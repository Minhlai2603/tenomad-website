...
```
Agent(
  prompt="Read D:/gsd-tenomad-blog/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/gsd-tenomad-blog/.claude/gsd-core/templates/SECURITY.md`

...
```markdown
Read D:/gsd-tenomad-blog/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/gsd-tenomad-blog/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/gsd-tenomad-blog/.claude/agents/gsd-ui-checker.md for instructions.

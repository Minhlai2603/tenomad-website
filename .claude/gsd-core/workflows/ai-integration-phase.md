...
<required_reading>
@D:/gsd-tenomad-blog/.claude/gsd-core/references/ai-frameworks.md
@D:/gsd-tenomad-blog/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read D:/gsd-tenomad-blog/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "D:/gsd-tenomad-blog/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read D:/gsd-tenomad-blog/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read D:/gsd-tenomad-blog/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read D:/gsd-tenomad-blog/.claude/agents/gsd-eval-planner.md for instructions.

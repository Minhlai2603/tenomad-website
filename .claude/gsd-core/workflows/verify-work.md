...
<template>
@D:/gsd-tenomad-blog/.claude/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@D:/gsd-tenomad-blog/.claude/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `D:/gsd-tenomad-blog/.claude/gsd-core/workflows/transition.md`.
...
- Follow @D:/gsd-tenomad-blog/.claude/gsd-core/workflows/diagnose-issues.md

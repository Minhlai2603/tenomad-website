...
- Usage: Reference from command with `@D:/gsd-tenomad-blog/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to D:/gsd-tenomad-blog/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/gsd-tenomad-blog/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

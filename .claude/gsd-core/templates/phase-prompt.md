...
<!-- For checkpoint task examples and patterns, see @D:/gsd-tenomad-blog/.claude/gsd-core/references/checkpoints.md -->
...
See `D:/gsd-tenomad-blog/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `D:/gsd-tenomad-blog/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `D:/gsd-tenomad-blog/.claude/gsd-core/workflows/verify-phase.md` for verification logic.

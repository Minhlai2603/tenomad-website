...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `D:/gsd-tenomad-blog/.claude/.gsd-surface.json`
(sibling to `D:/gsd-tenomad-blog/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `D:/gsd-tenomad-blog/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`D:/gsd-tenomad-blog/.claude/skills`).
...
`D:/gsd-tenomad-blog/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `D:/gsd-tenomad-blog/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `D:/gsd-tenomad-blog/.claude/.gsd-surface.json`
Install profile marker: `D:/gsd-tenomad-blog/.claude/.gsd-profile`
Skill dirs: `D:/gsd-tenomad-blog/.claude/skills/gsd-*/`
Engine module: `D:/gsd-tenomad-blog/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `D:/gsd-tenomad-blog/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
